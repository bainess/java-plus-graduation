package ru.yandex.practicum.eventservice.event.service.predicate;
...
import ru.yandex.practicum.eventservice.event.model.QEvent;
...
public class EventPredicate {
    ...
    public static BooleanExpression buildAdmin(EventSearchParamsAdmin params) {
        ...
        if (params.getUsers() != null && !params.getUsers().isEmpty()) {
            predicate = predicate.and(event.initiator.in(params.getUsers()));
        }
