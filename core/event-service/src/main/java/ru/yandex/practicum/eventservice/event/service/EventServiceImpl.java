...
import ru.practicum.explorewithme.shareddto.enums.UserEventStateAction;
...
import ru.yandex.practicum.eventservice.event.mapper.EventMapper;
...
public class EventServiceImpl implements EventService {
    ...
    public EventFullDto addEvent(Long userId, NewEventDto newEventDto) {
        ...
        Long user = userClient.findById(userId).getId();
    ...
    public List<EventShortDto> getEvents(Long userId, int from, int size) {
        ...
        List<Event> events = eventRepository.findAllByInitiator(userId, pageable).getContent();
    ...
    public EventFullDto getEvent(Long userId, Long eventId) {
        ...
        Event event = eventRepository.findByIdAndInitiator(eventId, userId).orElseThrow(() -> new NotFoundException("Событие с id=" + eventId + " не найдено или недоступно"));
        Long confirmed = requestClient.countByEventIdAndStatus(eventId).longValue();
    ...
    private Map<Long, Long> getConfirmedRequests(List<Event> events) {
        ...
        return requestClient.countConfirmedRequestsByEventIds(eventIds).stream().collect(Collectors.toMap(ConfirmedRequestsCount::getEventId, ConfirmedRequestsCount::getCount));
    }
    ...
    public EventFullDto getEventPublic(Long eventId) {
        ...
        Long confirmedRequests = Long.valueOf(requestClient.countByEventIdAndStatus(eventId));
    ...
    public EventFullDto getEventFullDto(Long eventId, Long userId) {
        ...
        Event event = eventRepository.findByIdAndInitiator(eventId, userId)
                .orElseThrow(() -> new NotFoundException("Event was not found: event id=" + eventId + "user id=" + userId));
        return EventMapper.toFullDto(event);
    }

    public EventFullDto getEventFullDto(Long eventId) {
        Optional<Event> event = eventRepository.findById(eventId);
                Event ecent = event.orElseThrow(() -> new NotFoundException("Event id=" + eventId + " was not found"));
        return EventMapper.toFullDto(ecent);
    }

    @Override
    public Set<EventFullDto> findAllById(Set<Long> eventIds) {
        List<Event> events = eventRepository.findAllById(eventIds);
        return events.stream().map(EventMapper::toFullDto).collect(Collectors.toSet());
    }

    @Override
    public Set<EventShortDto> findAllByIdShort(Set<Long> eventIds) {
        List<Event> events = eventRepository.findAllById(eventIds);
