...
public class EventServiceImpl implements EventService {
    ...
    public EventFullDto addEvent(Long userId, NewEventDto newEventDto) {
        ...
        Long user = userClient.findById(userId).userId();
    ...
    public EventFullDto getEvent(Long userId, Long eventId) {
        ...
        Long confirmed = requestClient.countByEventIdAndStatus(eventId, ParticipationRequestStatus.CONFIRMED).longValue();
    ...
    public EventFullDto getEventPublic(Long eventId) {
        ...
        Long confirmedRequests = Long.valueOf(requestClient.countByEventIdAndStatus(eventId, ParticipationRequestStatus.CONFIRMED));
