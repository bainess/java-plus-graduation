package ru.yandex.practicum.requestservice.dal;
...
public interface EventRequestRepository extends JpaRepository<ParticipationRequest, Long> {
    ...
    @Query("SELECT new ru.practicum.explorewithme.shareddto.dto.request.ConfirmedRequestsCount(r.eventId, COUNT(r.id)) " +
